...
-keep class com.superpenguin.foreigninputandoutput.inputEngine.KeyboardEngine{*;}
-keep class com.superpenguin.foreigninputandoutput.method.ContactsBinaryDictionary{*;}