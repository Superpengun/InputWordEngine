...
import com.superpenguin.foreigninputandoutput.utils.DialogUtils;
import com.superpenguin.foreigninputandoutput.utils.IntentUtils;
...
public final class CustomInputStyleSettingsFragment extends PreferenceFragment
    ...
    private InputMethodSubtype findDuplicatedSubtype(final InputMethodSubtype subtype) {
        ...
        final String keyboardLayoutSetName = SubtypeLocaleUtils.getKeyboardLayoutSetName();
