...
import com.superpenguin.foreigninputandoutput.method.permissions.PermissionsUtil;
import com.superpenguin.foreigninputandoutput.method.personalization.UserHistoryDictionary;
...
import com.superpenguin.foreigninputandoutput.utils.SuggestionResults;
...
public class DictionaryFacilitatorImpl implements DictionaryFacilitator {
    ...
    @Nonnull public SuggestionResults getSuggestionResults(ComposedData composedData,
        ...
        if (suggestionResults.size() == 0){
            Log.d(TAG, "getSuggestionsFacili: none");
        }else {
            String testResult = "";
            for (int i =0;i<suggestionResults.size();i++){
                testResult = testResult+i+":"+suggestionResults.toArray()[i].toString()+" ";
            }
            Log.d(TAG, "getSuggestionsFacili:"+testResult);
        }
