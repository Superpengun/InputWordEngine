...
package com.superpenguin.foreigninputandoutput.method.settings;
...
import com.superpenguin.foreigninputandoutput.compat.ViewCompatUtils;
...
import com.superpenguin.foreigninputandoutput.utils.AdditionalSubtypeUtils;
...
final class CustomInputStylePreference extends DialogPreference
    ...
    static final class KeyboardLayoutSetItem {
        ...
        public KeyboardLayoutSetItem(final InputMethodSubtype subtype) {
            mLayoutName = SubtypeLocaleUtils.getKeyboardLayoutSetName();
            mDisplayName = SubtypeLocaleUtils.getKeyboardLayoutSetDisplayName();
        }
